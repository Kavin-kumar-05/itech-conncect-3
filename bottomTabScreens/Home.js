...
function Home() {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get('https://bcec696dad7a74e988364eac6abea523.serveo.net/api/update/', config);
          setData(response.data);
          console.log("fetched data is "+response.data); // Set response data to state
        } catch (error) {
          console.error(error);
        }
      };
